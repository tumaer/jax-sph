...
def erfc_jax(x: float):
    ...
    from "Approximate Incomplete Integrals, Application to Complementary Error Function",
    by Yaya D. Dia, 2023
...
def erf_jax_power(x: float, n: int = 10):
    """JAX jit-able vmap compatible implementation for computing the error function as power series.
