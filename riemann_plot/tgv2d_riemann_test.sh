...
do
    ...
    ./venv/bin/python main.py --case=TGV --solver=RIE2 --dim=2 --dx=$dx --nxnynz=$nxnynz --t-end=4 --seed=123 --write-h5 --write-every=$write_every --data-path="data_Riemann/tgv2d_Rie_lim/" --gpu=0 --density-evolution --is-limiter --eta-limiter=3
    #./venv/bin/python main.py --case=TGV --solver=RIE2 --dim=2 --dx=$dx --nxnynz=$nxnynz --t-end=4 --seed=123 --write-h5 --write-every=$write_every --data-path="data_Riemann/tgv2d_Rie_nolim/" --gpu=0 --density-evolution
done

# Run validation script
CUDA_VISIBLE_DEVICES=0 ./venv/bin/python riemann_plot/riemann_tgv_plot.py --case=2D_TGV_RIE --src_dir="data_Riemann/tgv2d_Rie_lim/"
