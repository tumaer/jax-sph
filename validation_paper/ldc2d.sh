...
./venv/bin/python main.py --case=LDC --solver=RIE --viscosity=0.01 --tvf=0.0 --dim=2 --dx=0.02 --dt=0.0004 --t-end=20.0 --seed=123 --write-h5 --write-every=100 --write-vtk --data-path="data_valid/ldc2d_Riemann" --density-evolution --is-limiter --eta-limiter=3
