...
do
    ...
    ./venv/bin/python main.py --case=TGV --solver=RIE2 --viscosity=0.02 --tvf=0.0 --dim=3 --dx=$dx --nxnynz=$nxnynz --t-end=10 --seed=123 --write-h5 --write-vtk --write-every=$write_every --data-path="data_valid/tgv3d_Rie" --gpu=0 --density-evolution --is-limiter --eta-limiter=3
