...
do
    ...
    ./venv/bin/python main.py --case=TGV --solver=SPH --tvf=1.0 --dim=2 --dx=$dx --nxnynz=$nxnynz --t-end=0.5 --seed=123 --write-h5 --write-every=$write_every --data-path="data_valid/tgv2d_tvf/" --gpu=0
