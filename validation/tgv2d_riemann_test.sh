...
#./venv/bin/python main.py --case=Rlx --solver=SPH --tvf=1.0 --dim=2 --dx=0.05 --nxnynz=20_20_0 --seed=123 --write-h5 --write-every=10 --r0-noise-factor=0.25 --relax-pbc --data-path=data_relaxed --p-bg-factor=0.02 --gpu=0
...
./venv/bin/python main.py --case=TGV --solver=RIE --dim=2 --dx=0.01 --nxnynz=100_100_0 --Vmax=1.0 --t-end=10 --seed=123 --write-h5 --write-every=50 --data-path="data_Riemann/tgv2d_lim/" --gpu=0 --is-limiter #--eta-limiter=300000
