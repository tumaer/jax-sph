...
do
    ...
    dx="${a[0]}"
    write_every="${a[1]}"
    python main.py --case=TGV --mode=rlx --solver=SPH --tvf=1.0 --dim=3 --dx=$dx --seed=123 --write-h5 --write-every=10 --r0-noise-factor=0.25 --data-path=data_relaxed --p-bg-factor=0.02 --nl-backend=jaxmd_vmap
