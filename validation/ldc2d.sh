...
python main.py config=cases/ldc.yaml solver.name=SPH solver.tvf=1.0 solver.t_end=20.0 case.state0_path=data_relaxed/ldc_2_0.02_123.h5 io.data_path=data_valid/ldc2d_tvf/
...
python main.py config=cases/ldc.yaml solver.name=RIE solver.tvf=0.0 solver.t_end=20.0 case.state0_path=data_relaxed/ldc_2_0.02_123.h5 io.data_path=data_valid/ldc2d_Riemann/
